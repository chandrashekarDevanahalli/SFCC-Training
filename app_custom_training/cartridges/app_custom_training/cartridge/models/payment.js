...
function getSelectedPaymentInstruments(selectedPaymentInstruments) {
    return collections.map(selectedPaymentInstruments, function (paymentInstrument) {
        ...
        } else if (paymentInstrument.paymentMethod === 'MERKLE_WALLET') {
            results.merkleWalletOwnerName = paymentInstrument.custom.merkleWalletFirstName + ' ' + paymentInstrument.custom.merkleWalletLastName;
            results.merkleWalletPhoneNumber = paymentInstrument.custom.merkleWalletPhoneNumber;
            results.type = 'Merkle Wallet';
