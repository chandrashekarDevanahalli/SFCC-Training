...
(function () {
    ...
    $(function () {
        var payPalAllOptionsBannerSelectorName= '.js_paypal_fo_allOptionsBanner';
        updateLabelValues();
        $('body').on('click', '.js_paypal_fo_show_allOptionsBanner', function () {
            $(this).parents('.js_paypal_fo_banner_content').hide();
            $(this).parents('.js_paypal_fo_banner').find(payPalAllOptionsBannerSelectorName).removeClass('js_paypal_fo_allOptionsBanner_hide');
        });
        ...
        $('body').on('paypal:updateCartTotals', function () {
            updateBanner($(payPalAllOptionsBannerSelectorName).data('url') + '&isGetCartTotalAsValue=true&t=' + Date.now());
        });
        $('body').on('product:afterAttributeSelect', function (e, data) {
            ...
            updateBanner($(payPalAllOptionsBannerSelectorName).data('url') + '&value=' + value);
        });
    });
