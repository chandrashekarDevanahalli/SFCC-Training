...
function beforePUT(_, customerInfo) {
    ...
    if (!email) {
        Logger.error(Resource.msg('paypal.ocapi.error.email.address.isrequired', 'locale', null));
        ...
        Logger.error(Resource.msg('paypal.ocapi.error.email.address.not.valid', 'locale', null));
