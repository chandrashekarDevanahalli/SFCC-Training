...
const { getPaypalPaymentInstrument } = require('*/cartridge/scripts/paypal/helpers/paymentInstrumentHelper');

let autorizationAndCaptureWhHelper = {};
...
autorizationAndCaptureWhHelper.updateOrderPaymentStatus = function (order, paymentStatus) {
    Transaction.wrap(function () {
        ...
        if (order instanceof CustomObject) {
            ...
            let paymentInstrument = getPaypalPaymentInstrument(order);
