...
function disabledPaymentOptions() {
    ...
    return disableFunds.filter(function (fund) {
        return Array.indexOf(enabledLPMsArray, fund) === -1;
    });
}
...
function createBillingSDKUrl() {
    ...
    var isActiveLPM = !billingAgreementEnabled && isCapture && enabledLPMsArray.length !== 0;
