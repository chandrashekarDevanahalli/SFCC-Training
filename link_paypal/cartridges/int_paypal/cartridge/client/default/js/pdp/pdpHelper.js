...
if ($paypalPDPButton) {
    ...
    var $miniCartQuantityElement = document.querySelector('.minicart-quantity');
    ...
    if (($miniCartQuantityElement && parseInt($miniCartQuantityElement.textContent, 0) > 0)
    ...
    $('body').on('cart:update', function () {
        var miniCartQuantity = parseInt($miniCartQuantityElement.textContent, 0);
        if ($addToCartButton.disabled) {
            hidePDPButton($paypalPDPButton);
        }
