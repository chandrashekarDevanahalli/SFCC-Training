...
function showCartErrorHtml(message) {
    ...
    $('.cart-error').append(
        `<div class="alert alert-danger alert-dismissible valid-cart-error fade show cartError d-flex justify-content-center" role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
            <span class="text-center p-4">${message}</span>
        </div>`
    );
    window.scrollTo(0, 0);
}
 ...
 */
function getBillingAgreementToken(isCartFlow = false, isSkipShippingAddress) {
