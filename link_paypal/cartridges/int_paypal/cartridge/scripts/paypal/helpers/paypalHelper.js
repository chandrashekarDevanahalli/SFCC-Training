...
function getPurchaseUnit(currentBasket, isCartFlow) {
    ...
    var description = [getItemsDescription(productLineItems), getGiftCertificateDescription(giftCertificateLineItems)].join(' ');
...
function isPurchaseUnitChanged(purchaseUnit) {
    if (!session.privacy.orderDataHash) {
        return true;
    }
 ...
 */
function getBARestData(isCartFlow, isSkipShippingAddress) {
    var baTokenData = {
        ...
        body: {
            ...
            plan: {
                ...
                merchant_preferences: {
                    ...
                    skip_shipping_address: isSkipShippingAddress,
...
function getAccessToken(credentials) {
    var authCredentials = [credentials.user, credentials.password].join(':');
