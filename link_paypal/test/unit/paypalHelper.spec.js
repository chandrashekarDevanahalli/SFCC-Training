...
describe('paypalHelper file', () => {
    describe('getTransactionId function', () => {
        let getTransactionId = paypalHelper.__get__('getTransactionId');
        let transactionResponseAuthorization = {
            purchase_units: [{
                payments: {
        ...
        let transactionResponseCapture = {
            purchase_units: [{
                payments: {
    ...
    describe('getTransactionStatus function', () => {
        let getTransactionStatus = paypalHelper.__get__('getTransactionStatus');
        ...
        let transactionResponseCaptures = {
            purchase_units: [{
                payments: {
                    captures: [{
                        id: '3E179939TX5111812E',
